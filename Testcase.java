...
public class Testcase {
    ...
    @JacksonXmlElementWrapper(localName = "failure", useWrapping = false)
    @JacksonXmlProperty(localName = "failure")
    private List<Failure> failure = new ArrayList<>();

    @JacksonXmlElementWrapper(localName = "system-out", useWrapping = false)
    @JacksonXmlProperty(localName = "system-out")
    private List<String> systemOut = new ArrayList<>();

    @JacksonXmlElementWrapper(localName = "system-err", useWrapping = false)
